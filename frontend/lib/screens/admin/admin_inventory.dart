...
class _AdminInventoryScreenState extends State<AdminInventoryScreen> {
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(message, textAlign: TextAlign.center, style: GoogleFonts.poppins(fontSize: 20, fontWeight: FontWeight.bold, color: AppColors.primaryDarkTeal)),
  ...
  Widget build(BuildContext context) {
    Widget content = Column(
      children: [
        if (widget.isSubPage) ...[
          ...
          Text('Inventory', style: GoogleFonts.poppins(color: Colors.white, fontSize: 26, fontWeight: FontWeight.bold)),
                      ...
                      return Padding(
                        ...
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Text(cat, style: GoogleFonts.poppins(fontSize: 12, color: Colors.white)),
                          ),
                        ),
                      );
                    },
                                ...
                                Expanded(
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text(product['category'], style: GoogleFonts.poppins(fontSize: 11, color: Colors.black45, fontStyle: FontStyle.italic)),
                                    ],
                                  ),
                                ),
                                Column(
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Inventory', style: GoogleFonts.poppins(color: Colors.white, fontSize: 26, fontWeight: FontWeight.bold)),
      ),
      body: content,
    );
  }
  ...
  Widget _buildStatusTag(String status) {
    ...
    return Container(
      ...
      child: Text(status, style: GoogleFonts.poppins(color: Colors.white, fontSize: 9, fontWeight: FontWeight.bold)),
    );
  }
}
