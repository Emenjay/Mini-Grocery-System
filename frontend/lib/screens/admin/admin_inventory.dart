              ...
              children: [
                ...
                _buildExpansionTile(
                  ...
                  children: [
                    ...
                    _buildDrawerLink(
                      "Out of Stock",
                      isSelected: selectedStockStatuses.contains(
                        "Out of Stock",
                      ),
                      onTap: () => setState(
                        () => selectedStockStatuses = {"Out of Stock"},
                      ),
                    ),
                  ],
                ),
                _buildExpansionTile(
                  "Expiration Date",
                  children: [
                    ...expirationChoices.map(
                      (choice) => _buildDrawerLink(
                        choice,
                        isSelected: selectedExpirationFilters.contains(choice),
                        onTap: () => setState(
                          () => selectedExpirationFilters = {choice},
                        ),
                      ),
                    ),
                  ],
